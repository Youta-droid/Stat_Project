...
**Interpretation:**\
The clustering analysis reveals three distinct groups of countries based on GDP per capita and social support. Countries in Cluster 1 are characterized by lower levels of both factors and a greater variability, whereas Cluster 3 contains countries with the highest GDP and strongest social support systems. Cluster 2 occupies an intermediate position. The clear separation of these groups suggests that economic prosperity and social support jointly play an important role in explaining differences in happiness across countries. Countries that perform well on both dimensions tend to belong to the cluster associated with higher well-being outcomes.
