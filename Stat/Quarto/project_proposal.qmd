...
Next we look at each variable one at a time — its center, spread, and shape — using the complete-case data that feeds the rest of the analysis.
...
#' creates hovering message windows for the interactive plot by plotly
#' returns the information about countryname, year, the value of the regarding parameter
#' and happiness score
...
# the variables for the column names are wrapped in {{}}. The actual columns are not. 
